...
#Função para Plotar Informações
...
print("Como Usar:")
print("Defina categorias, gastos orçados e por ultimo gastos realizados")
c = int(input("Quantas Categorias deseja adicionar? (Númerico)"))
categorias = []
orcado = []
realizado = []
...
plotar(categorias, orcado, realizado)
